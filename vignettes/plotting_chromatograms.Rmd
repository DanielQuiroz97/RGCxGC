...
some authors claims this difference as an ortogonal separation.
Altough, it can not be always achieved since the chemistry of both columns
...
The color palett of this chromatogram might not be suitable. One of 
...
palette the variation of lower signals intensites is obscured by a blue
...
how they work. For example, TOF mas analyzer can acquiere
...
peak volumen in the modulation $(i)$, and reinjects the remaining peak volumen in the
