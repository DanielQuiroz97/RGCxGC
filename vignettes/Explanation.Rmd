...
alignment can be performed with function **batch_2DCOW**. This function takes
...
You can access to the whole dataset with the MetaboLights identifier
...
NetCDF file, which is first check for validity before import the chromatogram.
